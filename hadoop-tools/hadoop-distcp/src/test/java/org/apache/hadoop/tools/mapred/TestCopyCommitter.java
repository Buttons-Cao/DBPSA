...
public class TestCopyCommitter {
	...
	public void testNoCommitAction() {
		...
		JobContext jobContext = new JobContextImpl(taskAttemptContext.getConfiguration(),
			taskAttemptContext.getTaskAttemptID().getJobID(), taskAttemptContext.getArrivalTime(),
			taskAttemptContext.getDeadline());
		try {
	...
	public void testDeleteMissingFlatInterleavedFiles() {
		TaskAttemptContext taskAttemptContext = getTaskAttemptContext(config);
		JobContext jobContext = new JobContextImpl(taskAttemptContext.getConfiguration(),
			taskAttemptContext.getTaskAttemptID().getJobID(), taskAttemptContext.getArrivalTime(), taskAttemptContext.getDeadline());
		Configuration conf = jobContext.getConfiguration();
