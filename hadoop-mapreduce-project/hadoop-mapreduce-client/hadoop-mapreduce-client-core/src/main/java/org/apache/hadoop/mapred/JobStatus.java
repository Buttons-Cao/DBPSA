...
public class JobStatus extends org.apache.hadoop.mapreduce.JobStatus {
	...
	public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
	                 float cleanupProgress, int runState, long arrivalTime, long deadline) {
		this(jobid, mapProgress, reduceProgress, cleanupProgress, runState, null,
			null, null, null, arrivalTime, deadline);
	}
	...
	@Deprecated
	public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
	                 int runState, long arrivalTime, long deadline) {
		this(jobid, mapProgress, reduceProgress, runState, null, null, null, null, arrivalTime, deadline);
	}
	...
	@Deprecated
	public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
	                 float cleanupProgress, int runState, JobPriority jp, long arrivalTime, long deadline) {
		this(jobid, mapProgress, reduceProgress, cleanupProgress, runState, jp,
			null, null, null, null, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float setupProgress, float mapProgress,
	                 ...
	                 int runState, JobPriority jp, long arrivalTime, long deadline) {
		this(jobid, setupProgress, mapProgress, reduceProgress, cleanupProgress, runState, jp, null, null,
			null, null, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
	                 ...
	                 String jobFile, String trackingUrl, long arrivalTime, long deadline) {
		this(jobid, mapProgress, reduceProgress, cleanupProgress, runState,
			JobPriority.NORMAL, user, jobName, jobFile, trackingUrl, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
		...
		this(jobid, mapProgress, reduceProgress, 0.0f, runState, user, jobName,
			jobFile, trackingUrl, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float setupProgress, float mapProgress,
		...
		this(jobid, setupProgress, mapProgress, reduceProgress, cleanupProgress,
			runState, jp, user, jobName, "default", jobFile, trackingUrl, false, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float setupProgress, float mapProgress,
	                 float reduceProgress, float cleanupProgress,
	                 int runState, JobPriority jp, String user, String jobName,
	                 String jobFile, String trackingUrl, boolean isUber, long arrivalTime, long deadline) {
		this(jobid, setupProgress, mapProgress, reduceProgress, cleanupProgress,
			runState, jp, user, jobName, "default", jobFile, trackingUrl, isUber, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float setupProgress, float mapProgress,
		...
		this(jobid, setupProgress, mapProgress, reduceProgress, cleanupProgress,
			runState, jp,
			user, jobName, queue, jobFile, trackingUrl, false, arrivalTime, deadline);
	}
	...
	public JobStatus(JobID jobid, float setupProgress, float mapProgress,
		...
		super(jobid, setupProgress, mapProgress, reduceProgress, cleanupProgress,
			...
			user, jobName, queue, jobFile, trackingUrl, isUber, arrivalTime, deadline);
	}
	...
	public static JobStatus downgrade(org.apache.hadoop.mapreduce.JobStatus stat) {
		JobStatus old = new JobStatus(JobID.downgrade(stat.getJobID()),
			...
			stat.getTrackingUrl(), stat.isUber(), stat.getArrivalTime(), stat.getDeadline());
