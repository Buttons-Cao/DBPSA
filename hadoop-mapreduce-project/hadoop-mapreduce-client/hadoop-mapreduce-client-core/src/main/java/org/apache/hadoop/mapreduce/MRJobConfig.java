...
public interface MRJobConfig {
	...
	String DEFAULT_JOB_DEADLINE = "123940";

	public static String JOB_DEADLINE = "123940";
	...
	public static  String PREEMPTION_PRIORITY = null;
	...
	public static String JOB_ARRIVALTIME = null;

	String DEFAULT_JOB_PREEMPTION_PRIORITY = "0";

	public static String JOB_PREEMPTION_PRIORITY = "0";
}
