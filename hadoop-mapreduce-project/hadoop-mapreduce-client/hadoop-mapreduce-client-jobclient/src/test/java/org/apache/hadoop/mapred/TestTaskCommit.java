...
public class TestTaskCommit extends HadoopTestCase {
	...
	public void testTaskCleanupDoesNotCommit() throws Exception {
		...
		JobContext jContext = new JobContextImpl(job, attemptID.getJobID(), arrivalTime, arrivalTime + 1365795);
		...
		Task task = new MapTask(null, attemptID, 0, null, 1, jContext.getArrivalTime(), job.getDeadline());
		task.setConf(job);
