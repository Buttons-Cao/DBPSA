...
public class TestJobHistoryEventHandler {
	...
	public void testFirstFlushOnCompletionEvent() throws Exception {
		...
		try {
			...
			handleEvent(jheh, new JobHistoryEvent(t.jobId, new AMStartedEvent(
				t.appAttemptId, 200, t.containerId, "nmhost", 3000, 4000, -1, Long.parseLong(MRJobConfig.DEFAULT_JOB_DEADLINE))));
	...
	public void testMaxUnflushedCompletionEvents() throws Exception {
		...
		try {
			jheh.start();
			handleEvent(jheh, new JobHistoryEvent(t.jobId, new AMStartedEvent(
				t.appAttemptId, 200, t.containerId, "nmhost", 3000, 4000, -1, -1)));
			mockWriter = jheh.getEventWriter();
			verify(mockWriter).write(any(HistoryEvent.class));
	...
	public void testUnflushedTimer() throws Exception {
		...
		try {
			jheh.start();
			handleEvent(jheh, new JobHistoryEvent(t.jobId, new AMStartedEvent(
				t.appAttemptId, 200, t.containerId, "nmhost", 3000, 4000, -1, 666666)));
			mockWriter = jheh.getEventWriter();
			verify(mockWriter).write(any(HistoryEvent.class));
	...
	public void testAMStartedEvent() throws Exception {
		...
		try {
			jheh.start();
			handleEvent(jheh, new JobHistoryEvent(t.jobId, new AMStartedEvent(
				t.appAttemptId, 200, t.containerId, "nmhost", 3000, 4000, 100, 666666)));
