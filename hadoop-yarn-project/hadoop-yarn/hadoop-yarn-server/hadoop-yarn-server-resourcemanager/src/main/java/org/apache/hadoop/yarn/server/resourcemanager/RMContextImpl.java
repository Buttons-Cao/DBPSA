...
public class RMContextImpl implements RMContext {
	...
	public RMContextImpl(Dispatcher rmDispatcher,
	                     ...
	                     long arrivalTime, long deadline, int numOfBeingPreempted, float preemptionPriority) {
		this();
		...
		setDeadline(arrivalTime + deadline);
		setNumOfBeingPreemted(numOfBeingPreempted);
	...
	public RMContextImpl(Dispatcher rmDispatcher,
		...
		this(
			...
			null, arrivalTime, deadline, numOfBeingPreempted, preemptionPriority);
	}
	...
	public RMContextImpl(Dispatcher rmDispatcher,
		...
		this(
			...
			clientToAMTokenSecretManager,
			rmApplicationHistoryWriter,
			null, Time.now(), 9999999999999L, 0, 0);
	}
	...
	public void setNumOfBeingPreemted(int numOfBeingPreemted) {
		this.numOfBeingPreempted = numOfBeingPreemted;
	}
