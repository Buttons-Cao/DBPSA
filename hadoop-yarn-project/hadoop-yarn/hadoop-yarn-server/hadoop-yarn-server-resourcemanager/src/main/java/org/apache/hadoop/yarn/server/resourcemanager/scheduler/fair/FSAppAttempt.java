...
public class FSAppAttempt extends SchedulerApplicationAttempt
	...
	public Container createContainer(
		FSSchedulerNode node, Resource capability, Priority priority, long AppArrivalTime, long deadline,
	...
	private Resource assignContainer(
		...
		boolean reserved, long AppArrivalTime, long deadline,
		int numOfBeingPreempted, float preemptionPriority) {
		...
		if (reserved) {
			...
			container = createContainer(node, capability, request.getPriority(), AppArrivalTime, deadline, numOfBeingPreempted,
				preemptionPriority);
		}
	...
	private Resource assignContainer(FSSchedulerNode node, boolean reserved, long AppArrivalTime, long deadline,
	                                 int numOfBeingPreempted, float preemptionPriority) {
		if (LOG.isDebugEnabled()) {
			...
			for (Priority priority : prioritiesToTry) {
				...
				if (rackLocalRequest != null && rackLocalRequest.getNumContainers() != 0
					...
					return assignContainer(node, localRequest,
						NodeType.NODE_LOCAL, reserved, AppArrivalTime, deadline, numOfBeingPreempted, preemptionPriority);
				}
				...
				if (rackLocalRequest != null && rackLocalRequest.getNumContainers() != 0
					...
					return assignContainer(node, rackLocalRequest,
						NodeType.RACK_LOCAL, reserved, AppArrivalTime, deadline, numOfBeingPreempted, preemptionPriority);
				}
				...
				if (offSwitchRequest != null &&
					...
					if (!hasNodeOrRackLocalRequests(priority) ||
						...
						return assignContainer(
							node, offSwitchRequest, NodeType.OFF_SWITCH, reserved, AppArrivalTime, deadline,
