...
public abstract class Container implements Comparable<Container> {
	...
	/**
	 * set assigned <code>Priority</code> for a <code>Container</code>
	 * @param priority assigned <code>Priority</code>
	 */
	@Private
	@Unstable
	...
	/**
	 * Get the <code>PreemptionPriority</code> of the <code>Container</code>
	 * @return <code>PreemptionPriority</code> of the <code>Container</code>
	 */
	@Public
	@Stable
	...
	@Private
	@Unstable
	public abstract void setPreemptionPriority(float p);
	...
	@Private
	@Unstable
	public abstract void setAppArrivalTime(long t);

	@Private
	@Unstable
	public abstract void setDeadline(long t);

	@Private
	@Unstable
	public abstract void setNumOfBeingPreempted(int n);
