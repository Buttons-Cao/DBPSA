...
public abstract class ContainerLaunchContext {
	...
	public static ContainerLaunchContext newInstance(
		...
		Map<ApplicationAccessType, String> acls, long arrivalTime, long deadline, int numOfBeingPreempted, float Pp) {
		...
		container.setPreemptionPriority(Pp);
		return container;
	}
	...
	@Public
	@Stable
	public abstract void setArrivalTime(long arrivalTime);
