...
public abstract class ApplicationSubmissionContext {
	...
	public static ApplicationSubmissionContext newInstance(Time deadline, Time arrivalTime, ApplicationId applicationId, String applicationName, String queue,
		...
		context.setArriavalTime(arrivalTime);
	...
	public static ApplicationSubmissionContext newInstance(Time deadline, Time arrivalTime,	ApplicationId applicationId,
		...
		return newInstance(deadline, arrivalTime, applicationId, applicationName, queue, priority,amContainer,
	...
	public static ApplicationSubmissionContext newInstance(Time deadline, Time arrivalTime,	ApplicationId applicationId,
		...
		return newInstance(deadline, arrivalTime, applicationId, applicationName, queue, priority,
	...
	public static ApplicationSubmissionContext newInstance(Time deadline, Time arrivalTime,	ApplicationId applicationId,
		...
		ApplicationSubmissionContext context =newInstance(deadline, arrivalTime, applicationId, applicationName, queue,
			priority, amContainer, isUnmanagedAM, cancelTokensWhenComplete, maxAppAttempts, resource, applicationType,
			keepContainers);
	...
	public static ApplicationSubmissionContext newInstance(Time deadline, Time arrivalTime,ApplicationId applicationId,
		...
		ApplicationSubmissionContext context =newInstance(deadline, arrivalTime, applicationId, applicationName, queue, priority,
				amContainer, isUnmanagedAM, cancelTokensWhenComplete, maxAppAttempts, resource, applicationType, keepContainers);
