...
public class TestDSFailedAppMaster extends ApplicationMaster {
	...
	public TestDSFailedAppMaster(long arrivalTime, long deadline) {
		super(arrivalTime, deadline);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			TestDSFailedAppMaster appMaster = new TestDSFailedAppMaster(arrivalTime, arrivalTime + 654123L);
